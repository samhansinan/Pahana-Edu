...
<%
    ...
    Customer customer = dao.getCustomerByAccount(accNo);
%>
...
<body>
<div class="container">
    <h2>Edit Customer - <%= customer.getAccountNumber() %></h2>
    <form action="updateCustomer" method="POST">
        ...
        <label>Units:</label>
        <input type="number" name="units" value="<%= customer.getUnitsConsumed() %>" required><br>
